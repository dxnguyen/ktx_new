        ...
        <div class="g-block size-60">
            <div id="jlheading-3361-particle" class="g-content g-particle news-title-box">
                <div class="jlheading-3361 tm-secondary-font">
                    <h3 class="news-title tm-title jl-margin-remove-bottom jl-text-bold jl-h2"><a href="#">Tin tức -
                        ...
                        <?php foreach ($list as $key=>$item) :
                            if ($item) :
                                foreach ($item as $value) :
                                    ...
                                    $articleUrl = Route::_(RouteHelper::getArticleRoute($value->id));
                                    ?>

                                    <div data-tag="<?php echo $item[0]->cat_alias; ?>">
                                        <a class="tm-item jl-inline-clip jl-transition-toggle jl-link-toggle"
                                           href="<?php echo $articleUrl; ?>" target="_blank" title="<?php echo $item[0]->cat_title; ?>"
                                           aria-label="Improve Startup"
                                           jl-scrollspy-class>
