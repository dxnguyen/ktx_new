...
<div id="g-page-surround">
    ...
    <?php if ($this->countModules('comments')) : ?>
        <jdoc:include type="modules" name="comments" style="" />
    <?php endif; ?>

    <?php if ($this->countModules('partner')) : ?>
        <jdoc:include type="modules" name="partner" style="" />
    <?php endif; ?>

    <?php if ($this->countModules('campus')) : ?>
        <jdoc:include type="modules" name="campus" style="" />
    <?php endif; ?>

    <?php if ($this->countModules('menubottom')) : ?>
        <jdoc:include type="modules" name="menubottom" style="" />
    <?php endif; ?>
