...
namespace Events\Component\Events\Administrator\View\Events;
// No direct access
...
class HtmlView extends BaseHtmlView
{
	...
	protected function addToolbar()
	{
		...
		ToolbarHelper::title(Text::_('COM_EVENTS_TITLE_EVENTS'), "generic");
		...
		// Set sidebar action
		Sidebar::setAction('index.php?option=com_events&view=events');
	}
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.`title`' => Text::_('COM_EVENTS_EVENTS_TITLE'),
			'a.`image`' => Text::_('COM_EVENTS_EVENTS_IMAGE'),
			'a.`image_link`' => Text::_('COM_EVENTS_EVENTS_IMAGE_LINK'),
			'a.`start_date`' => Text::_('COM_EVENTS_EVENTS_START_DATE'),
			'a.`end_date`' => Text::_('COM_EVENTS_EVENTS_END_DATE'),
			'a.`created_date`' => Text::_('COM_EVENTS_EVENTS_CREATED_DATE'),
		);
	}
