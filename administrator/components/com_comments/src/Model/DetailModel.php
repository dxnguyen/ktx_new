...
namespace Comments\Component\Comments\Administrator\Model;
// No direct access.
...
class DetailModel extends AdminModel
{
	 ...
	 * @since  1.0.0
	 */
	protected $text_prefix = 'COM_COMMENTS';
	 ...
	 * @since  1.0.0
	 */
	public $typeAlias = 'com_comments.detail';
	...
	protected function loadFormData()
	{
		...
		$data = Factory::getApplication()->getUserState('com_comments.edit.detail.data', array());
	...
	public function duplicate(&$pks)
	{
		...
		// Access checks.
		if (!$user->authorise('core.create', 'com_comments'))
		{
	...
	protected function prepareTable($table)
	{
		...
		if (empty($table->id))
		{
			...
			{
				$db = $this->getDbo();
				$db->setQuery('SELECT MAX(ordering) FROM #__comments');
				$max             = $db->loadResult();
