...
namespace Comments\Component\Comments\Administrator\View\Detail;
// No direct access
...
class HtmlView extends BaseHtmlView
{
	...
	protected function addToolbar()
	{
		...
		ToolbarHelper::title(Text::_('COM_COMMENTS_TITLE_DETAIL'), "generic");
		...
		if ($this->state->params->get('save_history', 1) && $user->authorise('core.edit')) {
			ToolbarHelper::versions('com_comments.detail', $this->item->id);
		}
