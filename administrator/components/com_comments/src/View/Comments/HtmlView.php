...
namespace Comments\Component\Comments\Administrator\View\Comments;
// No direct access
...
class HtmlView extends BaseHtmlView
{
	...
	protected function addToolbar()
	{
		...
		$canDo = CommentsHelper::getActions();

		ToolbarHelper::title(Text::_('COM_COMMENTS_TITLE_COMMENTS'), "generic");
		...
		{
			$toolbar->preferences('com_comments');
		}

		// Set sidebar action
		Sidebar::setAction('index.php?option=com_comments&view=comments');
	}
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.`name`' => Text::_('COM_COMMENTS_COMMENTS_NAME'),
			'a.`comment`' => Text::_('COM_COMMENTS_COMMENTS_COMMENT'),
			'a.`image`' => Text::_('COM_COMMENTS_COMMENTS_IMAGE'),
			'a.`university`' => Text::_('COM_COMMENTS_COMMENTS_UNIVERSITY'),
			'a.`created_date`' => Text::_('COM_COMMENTS_COMMENTS_CREATED_DATE'),
		);
	}
