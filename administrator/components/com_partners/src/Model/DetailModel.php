...
namespace Partners\Component\Partners\Administrator\Model;
// No direct access.
...
class DetailModel extends AdminModel
{
	 ...
	 * @since  1.0.0
	 */
	protected $text_prefix = 'COM_PARTNERS';
	 ...
	 * @since  1.0.0
	 */
	public $typeAlias = 'com_partners.detail';
	...
	protected function loadFormData()
	{
		...
		$data = Factory::getApplication()->getUserState('com_partners.edit.detail.data', array());
	...
	public function duplicate(&$pks)
	{
		...
		// Access checks.
		if (!$user->authorise('core.create', 'com_partners'))
		{
	...
	protected function prepareTable($table)
	{
		...
		if (empty($table->id))
		{
			...
			{
				$db = $this->getDbo();
				$db->setQuery('SELECT MAX(ordering) FROM #__partners');
				$max             = $db->loadResult();
