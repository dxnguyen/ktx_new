...
<form
	action="<?php echo Route::_('index.php?option=com_partners&layout=edit&id=' . (int) $this->item->id); ?>"
	...
	<?php echo HTMLHelper::_('uitab.addTab', 'myTab', 'detail', Text::_('COM_PARTNERS_TAB_DETAIL', true)); ?>
	<div class="row-fluid">
		<div class="col-md-12 form-horizontal">
			<fieldset class="adminform">
				<legend><?php echo Text::_('COM_PARTNERS_FIELDSET_DETAIL'); ?></legend>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <?php if (!empty($this->item->image)) : ?>
                            <a href="<?php echo Route::_(Uri::root() . 'uploads/partners' . DIRECTORY_SEPARATOR . $this->item->image, false);?>">
                                <img src="<?php echo Route::_(Uri::root() . 'uploads/partners' . DIRECTORY_SEPARATOR . $this->item->image, false);?>" width="200" />
                            </a>
	...
	<?php if (Factory::getApplication()->getIdentity()->authorise('core.admin','partners')) : ?>
