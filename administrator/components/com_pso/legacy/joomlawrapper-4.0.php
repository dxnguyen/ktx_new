...
class MjJoomlaWrapper40 extends MjJoomlaWrapper
{
    /**
     * @param string $option
     * @return bool
    ...
    {
        return JFactory::getApplication()->getInput()->get($name, $default);
    }
    ...
    {
        return JFactory::getApplication()->getInput()->getWord($name, $default);
    }
    ...
    {
        return JFactory::getApplication()->getInput()->getCmd($name, $default);
    }
    ...
    {
        return JFactory::getApplication()->getInput()->getInt($name, $default);
    }
    ...
    {
        return JFactory::getApplication()->getLanguage();
    }
    ...
    {
        return JFactory::getApplication()->get($name, $default);
    }
    ...
    {
        return JFactory::getApplication()->set($name, $value);
    }
    ...
    public function getDbo()
    {
        ...
        return JFactory::getContainer()->get('DatabaseDriver');
    }
    ...
    {
        return JFactory::getApplication()->getIdentity();
    }
    ...
    public function sendMailToAdmins($subject, $message)
    {
        ...
        $userFactory = JFactory::getContainer()->get(Joomla\CMS\User\UserFactoryInterface::class);
    ...
    public function getCache($type, $group, $ttl, $cachebase = null)
    {
        ...
        return JFactory::getContainer()->get(Joomla\CMS\Cache\CacheControllerFactoryInterface::class)->createCacheController($type, $options);
    }
