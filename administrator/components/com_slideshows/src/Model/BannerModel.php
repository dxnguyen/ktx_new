...
namespace Slideshows\Component\Slideshows\Administrator\Model;
// No direct access.
...
class BannerModel extends AdminModel
{
	 ...
	 * @since  1.0.0
	 */
	protected $text_prefix = 'COM_SLIDESHOWS';
	 ...
	 * @since  1.0.0
	 */
	public $typeAlias = 'com_slideshows.banner';
	...
	protected function loadFormData()
	{
		...
		$data = Factory::getApplication()->getUserState('com_slideshows.edit.banner.data', array());
	...
	public function duplicate(&$pks)
	{
		...
		// Access checks.
		if (!$user->authorise('core.create', 'com_slideshows'))
		{
	...
	protected function prepareTable($table)
	{
		...
		if (empty($table->id))
		{
			...
			{
				$db = $this->getDbo();
				$db->setQuery('SELECT MAX(ordering) FROM #__slideshows');
				$max             = $db->loadResult();
