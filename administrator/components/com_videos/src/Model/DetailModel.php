...
namespace Videos\Component\Videos\Administrator\Model;
// No direct access.
...
class DetailModel extends AdminModel
{
	 ...
	 * @since  1.0.0
	 */
	protected $text_prefix = 'COM_VIDEOS';
	 ...
	 * @since  1.0.0
	 */
	public $typeAlias = 'com_videos.detail';
	...
	protected function loadFormData()
	{
		...
		$data = Factory::getApplication()->getUserState('com_videos.edit.detail.data', array());
	...
	public function duplicate(&$pks)
	{
		...
		// Access checks.
		if (!$user->authorise('core.create', 'com_videos'))
		{
	...
	protected function prepareTable($table)
	{
		...
		if (empty($table->id))
		{
			...
			{
				$db = $this->getDbo();
				$db->setQuery('SELECT MAX(ordering) FROM #__videos');
				$max             = $db->loadResult();
