...
namespace Videos\Component\Videos\Administrator\View\Detail;
// No direct access
...
class HtmlView extends BaseHtmlView
{
	...
	protected function addToolbar()
	{
		...
		ToolbarHelper::title(Text::_('COM_VIDEOS_TITLE_DETAIL'), "generic");
		...
		if ($this->state->params->get('save_history', 1) && $user->authorise('core.edit')) {
			ToolbarHelper::versions('com_videos.detail', $this->item->id);
		}
